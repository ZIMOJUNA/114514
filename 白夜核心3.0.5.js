	...
	let e = /* @__PURE__ */ new Map(), t = null, n = () => {
		...
		i.forEach((e) => {
			...
			if (d && Array.from(d.children).forEach((e) => {
				if (e.classList && e.classList.contains("pm-status-bar-container")) return;
				let t = (e.textContent || "").toUpperCase().trim();
				(t.startsWith("战术聚焦:") || t.startsWith("战术聚焦：") || t.includes("战术聚焦:")) && (e.style.display = "none"), (t.includes("_.SET(") || t.includes("UPDATEVARIABLE")) && (e.style.display = "none"), t.includes("STATUSBAR_DATA") && (e.style.display = "none");
