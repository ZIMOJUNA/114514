              ...
              (function(){
                if (typeof document !== 'undefined' && !document.getElementById('seven-days-injected-styles')) {
                  ...
                  style.textContent = "@keyframes stb-pm-terminal-breathe-c36aba3a{0%{border-color:#222}50%{border-color:#444}to{border-color:#222}}.stb-pm-wrapper[data-v-c36aba3a]{overflow-wrap:anywhere;box-sizing:border-box;color:#d0d0d0;background-color:#050505;background-image:linear-gradient(#ffffff05 1px,#0000 1px),linear-gradient(90deg,#ffffff05 1px,#0000 1px);background-position:0 0;background-repeat:repeat;background-size:24px 24px;background-attachment:scroll;background-origin:padding-box;background-clip:border-box;border:1px solid #333;border-top:4px solid #8a0303;border-bottom:4px solid #d4af37;border-radius:12px;width:100%;max-width:100%;padding:16px;font-family:Nunito,Quicksand,Segoe UI Rounded,Helvetica Rounded,Arial,sans-serif;animation:8s ease-in-out infinite stb-pm-terminal-breathe-c36aba3a;position:relative;overflow-x:hidden}.stb-pm-header[data-v-c36aba3a]{border-bottom:1px solid #d4af3733;justify-content:space-between;align-items:flex-start;margin-bottom:12px;padding-bottom:12px;display:flex;position:relative}.stb-pm-header[data-v-c36aba3a]:after{content:\"\";background:#d4af37;border-radius:2px;width:30%;height:2px;position:absolute;bottom:-1px;left:0;box-shadow:0 0 10px #d4af37}.stb-pm-location[data-v-c36aba3a]{color:#d4af37;letter-spacing:1px;text-shadow:0 0 12px #d4af3799;word-break:break-word;flex:1;align-items:center;gap:8px;font-family:Quicksand,Georgia,serif;font-size:clamp(16px,4vw,18px);font-weight:700;display:flex}.stb-pm-location[data-v-c36aba3a]:before{content:\"◆\";color:#8a0303;text-shadow:0 0 6px #8a0303;font-size:12px}.stb-pm-env-col[data-v-c36aba3a]{flex-direction:column;flex-shrink:0;align-items:flex-end;gap:6px;display:flex}.stb-pm-tag[data-v-c36aba3a]{white-space:nowrap;letter-spacing:.5px;background:#000c;border:1px solid #444;border-radius:12px;padding:4px 10px;font-size:12px;box-shadow:inset 0 0 8px #ffffff0d}.stb-pm-tag-time[data-v-c36aba3a]{color:#aaa;border-color:#555}.stb-pm-tag-weather[data-v-c36aba3a]{color:#ff6b6b;text-shadow:0 0 5px #8a0303cc;border-color:#8a0303}.stb-pm-bgm-container[data-v-c36aba3a]{margin-bottom:16px}.stb-pm-bgm-container details[data-v-c36aba3a]{background:linear-gradient(90deg,#ffffff08,#00000080);border:1px solid #333;border-left:3px solid #81d4fa;border-radius:8px;transition:all .3s;overflow:hidden}.stb-pm-bgm-container summary[data-v-c36aba3a]{color:#81d4fa;cursor:pointer;justify-content:space-between;align-items:center;padding:12px 16px;font-size:14px;font-weight:700;list-style:none;display:flex}.stb-pm-bgm-container summary[data-v-c36aba3a]::-webkit-details-marker{display:none}.stb-pm-bgm-container summary[data-v-c36aba3a]:hover{background:#81d4fa1a}.stb-pm-bgm-arrow[data-v-c36aba3a]{transition:transform .3s}.stb-pm-bgm-container details[open] .stb-pm-bgm-arrow[data-v-c36aba3a]{transform:rotate(180deg)}.stb-pm-bgm-content[data-v-c36aba3a]{background:#000;border-top:1px solid #333;justify-content:center;padding:12px;display:flex;overflow:hidden}.stb-pm-bgm-content>iframe[data-v-c36aba3a],.stb-pm-bgm-content>audio[data-v-c36aba3a]{border:none;border-radius:6px;outline:none;max-width:330px;height:86px;width:100%!important}@keyframes stb-btn-breathe-gold-c36aba3a{0%{box-shadow:0 0 5px #d4af3733}50%{box-shadow:0 0 15px #d4af3799}to{box-shadow:0 0 5px #d4af3733}}@keyframes stb-btn-breathe-blue-c36aba3a{0%{box-shadow:0 0 5px #81d4fa33}50%{box-shadow:0 0 15px #81d4fa99}to{box-shadow:0 0 5px #81d4fa33}}.stb-pm-actions[data-v-c36aba3a]{flex-wrap:wrap;gap:10px;margin-bottom:16px;display:flex}.stb-pm-btn[data-v-c36aba3a]{letter-spacing:1px;cursor:pointer;touch-action:manipulation;border-radius:20px;flex:1;justify-content:center;align-items:center;min-width:140px;height:40px;font-size:14px;font-weight:700;text-decoration:none;transition:all .2s;display:flex}.stb-pm-btn[data-v-c36aba3a]:active{transform:scale(.96)}@media (hover:hover){.stb-pm-btn[data-v-c36aba3a]:hover{filter:brightness(1.2)}}.stb-pm-btn-guide[data-v-c36aba3a]{color:#f4e7c1;background:linear-gradient(#d4af3726,#000c);border:1px solid #d4af37;animation:3s ease-in-out infinite stb-btn-breathe-gold-c36aba3a}.stb-pm-btn-mirror[data-v-c36aba3a]{color:#e1f5fe;background:linear-gradient(#81d4fa26,#000c);border:1px solid #81d4fa;animation:3s ease-in-out infinite stb-btn-breathe-blue-c36aba3a}.stb-pm-badges[data-v-c36aba3a]{flex-wrap:wrap;gap:10px;margin-bottom:16px;display:flex}.stb-pm-badge[data-v-c36aba3a]{color:#e0e0e0;background:linear-gradient(135deg,#ffffff0d,#00000080);border:1px solid #333;border-left:3px solid #d4af37;border-radius:8px;align-items:center;gap:8px;padding:8px 14px;font-size:14px;display:flex;box-shadow:0 2px 6px #00000080}.stb-pm-badge strong[data-v-c36aba3a]{color:#d4af37;font-weight:700}.stb-pm-badge-title[data-v-c36aba3a]{border-left-color:#81d4fa;flex:100%}.stb-pm-badge-title strong[data-v-c36aba3a]{color:#81d4fa}.stb-pm-tabs-container[data-v-c36aba3a]{flex-wrap:wrap;gap:4px;min-height:400px;display:flex;position:relative}.stb-pm-tab-label[data-v-c36aba3a]{display:inline-block}.stb-pm-tab-radio[data-v-c36aba3a]{display:none}.stb-tab-btn[data-v-c36aba3a]{color:#777;cursor:pointer;white-space:nowrap;letter-spacing:1px;user-select:none;background:linear-gradient(#0a0a0a,#111);border:1px solid #222;border-bottom:none;border-radius:8px 8px 0 0;padding:10px 16px;font-size:14px;transition:all .3s;position:relative}.stb-pm-tab-content[data-v-c36aba3a]{scrollbar-width:thin;scrollbar-color:#555 #0a0a0a;-webkit-overflow-scrolling:touch;border-top:1px solid #222;flex-direction:column;gap:16px;max-height:55vh;padding-top:16px;padding-right:8px;display:none;position:absolute;left:16px;right:16px;overflow-y:auto}.stb-pm-tab-content[data-v-c36aba3a]::-webkit-scrollbar{width:6px}.stb-pm-tab-content[data-v-c36aba3a]::-webkit-scrollbar-track{background:#0a0a0a;border-radius:3px}.stb-pm-tab-content[data-v-c36aba3a]::-webkit-scrollbar-thumb{background:#555;border-radius:3px}.stb-pm-tab-radio:checked~.stb-tab-btn[data-v-c36aba3a]{color:#fff;text-shadow:0 0 6px #fff9;background:linear-gradient(#8a030340,#0a0a0a);border-color:#555;font-weight:700}.stb-pm-tab-radio:checked~.stb-tab-btn[data-v-c36aba3a]:after{content:\"\";z-index:2;background:#d4af37;border-radius:2px;width:100%;height:3px;position:absolute;bottom:-1px;left:0;box-shadow:0 -2px 12px #d4af37,0 0 6px #fff}.stb-pm-tab-radio:checked~.stb-pm-tab-content[data-v-c36aba3a]{margin-top:40px;display:flex;top:100%}.stb-pm-panel[data-v-c36aba3a]{background:#0f0f12cc;border:1px solid #222;border-left:4px solid #555;border-radius:8px;min-width:0;padding:16px;transition:border-color .3s,box-shadow .3s;position:relative;box-shadow:inset 0 0 20px #000c}.stb-pm-panel[data-v-c36aba3a]:hover{border-left-color:#d4af37;box-shadow:inset 0 0 20px #000c,-3px 0 12px #d4af3740}.stb-pm-panel-title[data-v-c36aba3a]{color:#999;text-transform:uppercase;letter-spacing:2px;border-bottom:1px dashed #ffffff26;align-items:center;margin-bottom:12px;padding-bottom:6px;font-size:13px;font-weight:700;display:flex}.stb-pm-panel-title[data-v-c36aba3a]:before{content:\"■\";color:#555;margin-right:8px;font-size:10px}.stb-pm-bar-container[data-v-c36aba3a]{margin-bottom:14px}.stb-pm-bar-header[data-v-c36aba3a]{justify-content:space-between;margin-bottom:6px;font-size:14px;display:flex}.stb-pm-bar-label[data-v-c36aba3a]{text-shadow:0 0 5px;letter-spacing:1px;font-weight:700}.stb-pm-bar-value[data-v-c36aba3a]{color:#ccc;font-family:Courier New,Courier,monospace;font-size:14px}.stb-pm-bar-track[data-v-c36aba3a]{background:#0a0a0a;border:1px solid #333;border-radius:7px;width:100%;height:14px;position:relative;overflow:hidden;box-shadow:inset 0 2px 6px #000000e6,0 1px #ffffff0d}.stb-pm-bar-fill[data-v-c36aba3a]{border-radius:7px;height:100%;transition:width .5s}.stb-pm-bar-hp[data-v-c36aba3a]{background:linear-gradient(90deg,#ff6b6b,#8a0303);box-shadow:0 0 8px #ff6b6b99}.stb-pm-bar-mp[data-v-c36aba3a]{background:linear-gradient(90deg,#81d4fa,#0277bd);box-shadow:0 0 8px #81d4fa99}.stb-pm-bar-sp[data-v-c36aba3a]{background:linear-gradient(90deg,#81c784,#2e7d32);box-shadow:0 0 8px #81c78499}.stb-pm-bar-xp[data-v-c36aba3a]{background:linear-gradient(90deg,#fff59d,#fbc02d);box-shadow:0 0 8px #fff59d99}.stb-pm-status-list[data-v-c36aba3a]{flex-direction:column;gap:8px;margin-bottom:12px;display:flex}.stb-pm-limbs-grid[data-v-c36aba3a]{grid-template-columns:repeat(2,1fr);gap:10px;display:grid}@keyframes stb-critical-flash-c36aba3a{0%{background:#ff444426;border-color:#f44;box-shadow:0 0 10px #ff4444b3}50%{box-shadow:none;background:#ff44440d;border-color:#500}to{background:#ff444426;border-color:#f44;box-shadow:0 0 10px #ff4444b3}}.stb-pm-limb-card[data-v-c36aba3a]{background:linear-gradient(#1a1a1a,#0d0d0d);border:1px solid #333;border-radius:8px;flex-direction:column;justify-content:center;align-items:center;padding:12px;transition:transform .2s,border-color .2s;display:flex;position:relative;overflow:hidden}.stb-pm-limb-card[data-v-c36aba3a]:before{content:\"\";background:#333;width:100%;height:4px;position:absolute;top:0;left:0}.stb-pm-limb-name[data-v-c36aba3a]{color:#888;letter-spacing:1px;text-transform:uppercase;margin-bottom:6px;font-size:12px}.stb-pm-limb-stat[data-v-c36aba3a]{text-align:center;word-break:break-word;white-space:normal;font-size:14px;font-weight:700}.stb-pm-limb-card[data-status*=完好][data-v-c36aba3a]:before{background:#555}.stb-pm-limb-card[data-status*=完好] .stb-pm-limb-stat[data-v-c36aba3a]{color:#999}.stb-pm-limb-card[data-status*=轻度][data-v-c36aba3a]:before{background:#aaa}.stb-pm-limb-card[data-status*=轻度] .stb-pm-limb-stat[data-v-c36aba3a]{color:#ddd;text-shadow:0 0 4px #ffffff4d}.stb-pm-limb-card[data-status*=重伤][data-v-c36aba3a]{border-color:#ffb74d}.stb-pm-limb-card[data-status*=重伤][data-v-c36aba3a]:before{background:#ffb74d;box-shadow:0 0 6px #ffb74d}.stb-pm-limb-card[data-status*=重伤] .stb-pm-limb-stat[data-v-c36aba3a]{color:#ffcc80;text-shadow:0 0 6px #ffcc8099}.stb-pm-limb-card[data-status*=残废][data-v-c36aba3a],.stb-pm-limb-card[data-status*=断裂][data-v-c36aba3a]{animation:1s infinite stb-critical-flash-c36aba3a}.stb-pm-limb-card[data-status*=残废][data-v-c36aba3a]:before,.stb-pm-limb-card[data-status*=断裂][data-v-c36aba3a]:before{background:#f44}.stb-pm-limb-card[data-status*=残废] .stb-pm-limb-stat[data-v-c36aba3a],.stb-pm-limb-card[data-status*=断裂] .stb-pm-limb-stat[data-v-c36aba3a]{color:#ff6b6b;text-decoration:line-through}.stb-pm-limb-card[data-status*=义体][data-v-c36aba3a],.stb-pm-limb-card[data-status*=同化][data-v-c36aba3a],.stb-pm-limb-card[data-status*=再生][data-v-c36aba3a]{background:#d4af370d;border-color:#d4af37}.stb-pm-limb-card[data-status*=义体][data-v-c36aba3a]:before,.stb-pm-limb-card[data-status*=同化][data-v-c36aba3a]:before,.stb-pm-limb-card[data-status*=再生][data-v-c36aba3a]:before{background:#d4af37;box-shadow:0 0 6px #d4af37}.stb-pm-limb-card[data-status*=义体] .stb-pm-limb-stat[data-v-c36aba3a],.stb-pm-limb-card[data-status*=同化] .stb-pm-limb-stat[data-v-c36aba3a],.stb-pm-limb-card[data-status*=再生] .stb-pm-limb-stat[data-v-c36aba3a]{color:#f4e7c1;text-shadow:0 0 6px #d4af3780}.stb-pm-stats-grid[data-v-c36aba3a]{grid-template-columns:repeat(2,1fr);gap:10px;margin-bottom:16px;display:grid}.stb-pm-stat-box[data-v-c36aba3a]{background:#ffffff05;border:1px solid #333;border-radius:6px;justify-content:space-between;align-items:center;padding:10px 14px;display:flex;box-shadow:inset 0 0 10px #00000080}.stb-pm-stat-label[data-v-c36aba3a]{color:#888;text-transform:uppercase;font-size:13px;font-weight:700}.stb-pm-stat-value[data-v-c36aba3a]{color:#d4af37;text-shadow:0 0 5px #d4af3766;font-family:monospace;font-size:16px;font-weight:700}.stb-pm-folder[data-v-c36aba3a]{background:#ffffff08;border:1px solid #333;border-radius:6px;margin-bottom:10px;transition:all .3s;overflow:hidden}.stb-pm-folder summary[data-v-c36aba3a]{color:#eee;cursor:pointer;background:#0006;justify-content:space-between;align-items:center;padding:12px 14px;font-size:14px;font-weight:700;list-style:none;display:flex}.stb-pm-folder summary[data-v-c36aba3a]::-webkit-details-marker{display:none}.stb-pm-folder summary[data-v-c36aba3a]:hover{background:#ffffff0d}.stb-pm-folder-arrow[data-v-c36aba3a]{color:#888;font-size:12px;transition:transform .3s}.stb-pm-folder[open] .stb-pm-folder-arrow[data-v-c36aba3a]{transform:rotate(180deg)}.stb-pm-folder-content[data-v-c36aba3a]{border-top:1px solid #333;padding:12px}.stb-pm-folder-actions[data-v-c36aba3a]{background:#0009;border-top:1px dashed #444;justify-content:flex-end;padding:8px 12px;display:flex}.stb-pm-btn-small[data-v-c36aba3a]{color:#ccc;cursor:pointer;background:#222;border:1px solid #555;border-radius:4px;padding:4px 12px;font-size:12px;text-decoration:none;transition:all .2s}.stb-pm-btn-small[data-v-c36aba3a]:hover{color:#fff;background:#8a0303;border-color:#ff6b6b}.stb-pm-text-block[data-v-c36aba3a]{color:#ccc;word-wrap:break-word;white-space:normal;font-size:15px;line-height:1.6}.stb-pm-rumor-card[data-v-c36aba3a]{background:linear-gradient(90deg,#d4af3714,#0009);border:1px solid #222;border-left:4px solid #d4af37;border-radius:4px 8px 8px 4px;margin-bottom:12px;padding:12px 16px;transition:all .3s;position:relative}.stb-pm-rumor-card[data-v-c36aba3a]:after{content:\"\";background:linear-gradient(90deg,#0000,#000000e6);width:30px;height:100%;position:absolute;top:0;right:0}.stb-pm-rumor-card[data-v-c36aba3a]:hover{background:linear-gradient(90deg,#d4af3726,#0009);border-left-width:6px;transform:translate(4px);box-shadow:0 4px 12px #0009}.stb-pm-rumor-title[data-v-c36aba3a]{color:#d4af37;letter-spacing:1.5px;margin-bottom:8px;font-size:14px;font-weight:700}.stb-pm-rumor-text[data-v-c36aba3a]{color:#ddd;z-index:1;font-size:15px;line-height:1.6;position:relative}.stb-pm-terminal-data[data-v-c36aba3a]{color:#81d4fa;white-space:pre-wrap;word-break:break-all;font-family:Courier New,Courier,monospace;font-size:13px;line-height:1.5}.stb-pm-terminal-data-gold[data-v-c36aba3a]{color:#f4e7c1}.stb-pm-terminal-data-red[data-v-c36aba3a]{color:#ff6b6b}.stb-pm-info-row[data-v-c36aba3a]{border-bottom:1px dashed #333;flex-direction:row;justify-content:space-between;margin-bottom:8px;padding-bottom:4px;display:flex}.stb-pm-info-label[data-v-c36aba3a]{color:#999;font-size:14px}.stb-pm-info-value[data-v-c36aba3a]{color:#ccc;font-size:14px;font-weight:700}[data-v-928a4131]:root{--pm-gold:#d4af37;--pm-dark-red:#8b0000;--pm-black:#1a1105;--pm-text:#2c241b;--pm-bg-light:#fff;--pm-bg-mid:#fcfaf5;--pm-bg-dark:#f4ebd8}.pm-master-container[data-v-928a4131]{z-index:99999;background:radial-gradient(circle at center,var(--pm-bg-light) 0%,var(--pm-bg-mid) 50%,var(--pm-bg-dark) 100%);box-sizing:border-box;color:var(--pm-text);-webkit-overflow-scrolling:touch;flex-direction:column;align-items:center;height:100dvh;padding:5vh 5vw;font-family:Noto Serif SC,Songti SC,serif;display:flex;position:fixed;inset:0;overflow:hidden auto;box-shadow:inset 0 0 80px #fff}.pm-master-container[data-v-928a4131]:before{content:\"\";pointer-events:none;z-index:2;border:3px solid #d4af37cc;border-radius:0;animation:4s ease-in-out infinite alternate pm-border-glow-928a4131;position:fixed;inset:0}.pm-master-container[data-v-928a4131]:after{content:\"\";pointer-events:none;z-index:1;background-image:url(\"data:image/svg+xml;utf8,<svg viewBox=\\\"0 0 200 200\\\" xmlns=\\\"http://www.w3.org/2000/svg\\\"><filter id=\\\"noiseFilter\\\"><feTurbulence type=\\\"fractalNoise\\\" baseFrequency=\\\"0.85\\\" numOctaves=\\\"3\\\" stitchTiles=\\\"stitch\\\"/></filter><rect width=\\\"100%\\\" height=\\\"100%\\\" filter=\\\"url(%23noiseFilter)\\\" opacity=\\\"0.05\\\"/></svg>\");position:fixed;inset:0}@keyframes pm-border-glow-928a4131{0%{border-color:#d4af3766;box-shadow:inset 0 0 15px #d4af371a,0 0 15px #d4af3733}to{border-color:#d4af37;box-shadow:inset 0 0 40px #d4af374d,0 0 40px #d4af3780}}@keyframes slideDown-928a4131{0%{opacity:0;transform:translateY(-15px)}to{opacity:1;transform:translateY(0)}}.fade-enter-active[data-v-928a4131],.fade-leave-active[data-v-928a4131]{transition:opacity .6s,transform .6s}.fade-enter-from[data-v-928a4131],.fade-leave-to[data-v-928a4131]{opacity:0;transform:translateY(15px)}.page-check[data-v-928a4131],.library-scene[data-v-928a4131],.custom-char-page[data-v-928a4131],.page-settings[data-v-928a4131]{z-index:10;flex-direction:column;flex:1;align-items:center;width:100%;max-width:1000px;display:flex;position:relative}.page-check[data-v-928a4131]{justify-content:center}.sys-title[data-v-928a4131]{color:var(--pm-black);letter-spacing:10px;text-shadow:0 0 15px #d4af3799;text-align:center;margin-bottom:5px;font-size:clamp(2em,5vw,3.5em);font-weight:900}.sys-subtitle[data-v-928a4131]{color:var(--pm-dark-red);letter-spacing:3px;text-align:center;margin-bottom:50px;font-family:Brush Script MT,Great Vibes,cursive;font-size:clamp(1.2em,3vw,1.8em)}.sys-check-box[data-v-928a4131]{border-top:2px solid var(--pm-gold);border-bottom:2px solid var(--pm-gold);width:100%;max-width:500px;margin:0 auto 50px;padding:30px 0}.sys-row[data-v-928a4131]{color:#333;justify-content:space-between;margin:15px 0;font-size:1.2em;font-weight:700;display:flex}.status-ok[data-v-928a4131]{color:var(--pm-dark-red);text-shadow:0 0 10px #8b000033;font-family:monospace}.status-warn[data-v-928a4131]{color:#d4af37;font-family:monospace}.status-loading[data-v-928a4131]{color:#aaa;font-family:monospace;animation:1.5s infinite pulse-928a4131}@keyframes pulse-928a4131{0%{opacity:.5}50%{opacity:1}to{opacity:.5}}.sys-actions[data-v-928a4131]{justify-content:center;gap:30px;width:100%;max-width:500px;display:flex}.sys-btn[data-v-928a4131]{text-align:center;border:1px solid var(--pm-text);color:var(--pm-text);cursor:pointer;letter-spacing:4px;background:0 0;border-radius:4px;flex:1;padding:15px 0;font-family:inherit;font-size:1.2em;font-weight:700;transition:all .3s}.sys-btn[data-v-928a4131]:hover{background:var(--pm-text);color:var(--pm-bg-mid);box-shadow:0 8px 20px #00000026}.sys-btn-primary[data-v-928a4131]{border-color:var(--pm-dark-red);color:var(--pm-dark-red)}.sys-btn-primary[data-v-928a4131]:hover:not(:disabled){background:var(--pm-dark-red);color:#fff;box-shadow:0 8px 20px #8b000040}.sys-btn-primary[data-v-928a4131]:disabled{opacity:.5;color:#666;cursor:not-allowed;box-shadow:none;background:0 0;border-color:#666}.transition-note[data-v-928a4131]{z-index:210;background:radial-gradient(circle,#fff 0%,#fcfaf5 50%,#f4ebd8 100%);flex-direction:column;justify-content:center;align-items:center;padding:10%;animation:5.5s ease-in-out forwards noteSequence-928a4131;display:flex;position:absolute;inset:0}@keyframes noteSequence-928a4131{0%{opacity:0;transform:scale(.95)}10%{opacity:1;transform:scale(1)}80%{opacity:1;transform:scale(1)}to{opacity:0;visibility:hidden;pointer-events:none;transform:scale(1.05)}}.note-title[data-v-928a4131]{color:var(--pm-dark-red);border-bottom:2px solid var(--pm-gold);letter-spacing:3px;margin-bottom:30px;padding-bottom:15px;font-size:clamp(1.5em,3vw,2em);font-weight:700}.note-content[data-v-928a4131]{max-width:800px;color:var(--pm-text);font-size:clamp(1em,2vw,1.2em);line-height:2}.note-content li[data-v-928a4131]{margin-bottom:15px;list-style-type:square}.note-content li strong[data-v-928a4131]{color:var(--pm-dark-red);font-weight:900}.library-scene[data-v-928a4131]{box-sizing:border-box;z-index:200;width:100%;padding:20px 0;position:relative}.bgm-player[data-v-928a4131]{opacity:.3;z-index:220;width:280px;transition:opacity .4s;position:absolute;top:0;left:0}.bgm-player[data-v-928a4131]:hover{opacity:1}.bgm-player audio[data-v-928a4131]{outline:none;width:100%;height:40px}.scene-text[data-v-928a4131]{text-align:justify;text-indent:2em;max-width:900px;color:var(--pm-black);margin:60px auto 50px;font-size:clamp(1.1em,2.5vw,1.3em);line-height:2.2}.scene-text p[data-v-928a4131]{margin-bottom:20px}.highlight-red[data-v-928a4131]{color:var(--pm-dark-red);text-shadow:0 0 5px #8b000033;font-weight:900}.highlight-gold[data-v-928a4131]{color:var(--pm-gold);text-shadow:0 0 5px #d4af374d;font-weight:900}.trauma-text[data-v-928a4131]{color:var(--pm-dark-red);border-left:3px solid var(--pm-dark-red);text-indent:0;background:#8b00000d;border-radius:4px;margin:15px 0;padding:8px 15px;font-size:.9em;font-style:italic;font-weight:700;display:block}.dossier-container[data-v-928a4131]{flex-direction:column;gap:15px;width:100%;max-width:900px;margin:0 auto 40px;display:flex}.dossier-folder[data-v-928a4131]{border:1px solid var(--pm-gold);background:#ffffffb3;border-radius:6px;transition:all .3s;overflow:hidden;box-shadow:0 4px 10px #0000000d}.dossier-folder[open][data-v-928a4131]{border-color:var(--pm-dark-red);background:#fffffff2;box-shadow:0 10px 25px #8b000026}.dossier-summary[data-v-928a4131]{cursor:pointer;border-left:4px solid var(--pm-gold);align-items:center;padding:15px 20px;list-style:none;transition:all .3s;display:flex}.dossier-summary[data-v-928a4131]::-webkit-details-marker{display:none}.dossier-summary[data-v-928a4131]:hover{background:#d4af371a}.dossier-folder[open] .dossier-summary[data-v-928a4131]{border-left-color:var(--pm-dark-red);background:#8b00000d;border-bottom:1px dashed #8b000033}.ds-type[data-v-928a4131]{color:#888;letter-spacing:1px;width:80px;font-family:monospace;font-size:.9em}.ds-name[data-v-928a4131]{color:var(--pm-dark-red);letter-spacing:3px;flex:1;font-size:1.5em;font-weight:900}.ds-desc[data-v-928a4131]{color:#555;font-size:.95em;font-style:italic}.dossier-content[data-v-928a4131]{padding:30px;animation:.4s ease-out slideDown-928a4131}.cp-quote[data-v-928a4131]{color:#555;border-left:4px solid var(--pm-gold);background:#d4af370d;margin-bottom:30px;padding:15px 20px;font-family:Georgia,serif;font-size:1.1em;font-style:italic}.cp-grid[data-v-928a4131]{grid-template-columns:1fr 1fr;gap:25px;margin-bottom:30px;display:grid}.cp-box[data-v-928a4131]{background:#fff9;border:1px dashed #b89f7d;padding:20px}.cp-box-title[data-v-928a4131]{color:var(--pm-dark-red);letter-spacing:1px;border-bottom:1px solid #8b000033;margin-bottom:10px;padding-bottom:5px;font-size:1.1em;font-weight:900}.cp-box-content[data-v-928a4131]{color:#333;font-size:1.05em;line-height:1.8}.cp-actions[data-v-928a4131]{justify-content:center;margin-top:20px;display:flex}.cp-btn-confirm[data-v-928a4131]{cursor:pointer;border:2px solid var(--pm-dark-red);background:var(--pm-dark-red);color:#fff;letter-spacing:2px;text-align:center;border-radius:4px;padding:15px 50px;font-size:1.2em;font-weight:700;text-decoration:none;transition:all .3s;display:block}.cp-btn-confirm[data-v-928a4131]:hover{background:#5a0000;transform:translateY(-2px);box-shadow:0 5px 15px #8b00004d}.dossier-custom[data-v-928a4131]{background:var(--pm-black);border:1px solid var(--pm-dark-red);border-left:4px solid var(--pm-dark-red);cursor:pointer;border-radius:6px;align-items:center;margin-top:10px;padding:15px 20px;text-decoration:none;transition:all .3s;display:flex}.dossier-custom[data-v-928a4131]:hover{background:#2c1810;transform:translate(5px);box-shadow:0 5px 15px #8b00004d}.dossier-custom .ds-type[data-v-928a4131]{color:#aaa}.dossier-custom .ds-name[data-v-928a4131]{color:var(--pm-gold)}.custom-char-page[data-v-928a4131]{z-index:200;flex-direction:column;align-items:center;width:100%;padding:20px 0;display:flex;position:relative}.points-header[data-v-928a4131]{width:100%;color:var(--pm-gold);border:1px solid var(--pm-gold);z-index:300;backdrop-filter:blur(5px);box-sizing:border-box;background:#1a1105f2;border-radius:8px;justify-content:space-between;align-items:center;margin-bottom:30px;padding:15px 30px;display:flex;position:sticky;top:0;box-shadow:0 10px 20px #00000080}.points-header h2[data-v-928a4131]{letter-spacing:2px;margin:0;font-size:1.5em}.points-display[data-v-928a4131]{text-shadow:0 0 10px #d4af3780;font-family:monospace;font-size:2em;font-weight:900;transition:color .3s}.points-display.negative[data-v-928a4131]{color:#f44;text-shadow:0 0 15px #f00c;animation:2s infinite pulse-red-928a4131}@keyframes pulse-red-928a4131{0%{opacity:1}50%{opacity:.7}to{opacity:1}}.preset-bar[data-v-928a4131]{border:1px dashed var(--pm-gold);background:#fff9;border-radius:6px;flex-wrap:wrap;justify-content:space-between;align-items:center;gap:10px;width:100%;margin-bottom:20px;padding:15px;display:flex}.preset-select[data-v-928a4131]{border:1px solid var(--pm-gold);background:#fff;border-radius:4px;outline:none;padding:8px;font-family:inherit}.preset-btn[data-v-928a4131]{background:var(--pm-black);color:var(--pm-gold);border:1px solid var(--pm-gold);cursor:pointer;border-radius:4px;padding:8px 15px;transition:all .2s}.preset-btn[data-v-928a4131]:hover{background:var(--pm-dark-red);color:#fff}.preset-input[data-v-928a4131]{border:1px solid var(--pm-gold);border-radius:4px;outline:none;padding:8px}.roll-screen[data-v-928a4131]{text-align:center;flex-direction:column;justify-content:center;align-items:center;min-height:50vh;display:flex}.roll-btn[data-v-928a4131]{background:radial-gradient(circle,var(--pm-dark-red) 0%,var(--pm-black) 100%);border:4px solid var(--pm-gold);width:200px;height:200px;color:var(--pm-gold);cursor:pointer;border-radius:50%;flex-direction:column;justify-content:center;align-items:center;font-size:2em;font-weight:900;transition:all .2s;display:flex;box-shadow:0 0 30px #8b000080}.roll-btn[data-v-928a4131]:hover{transform:scale(1.05);box-shadow:0 0 50px #d4af3799}.roll-btn[data-v-928a4131]:active{transform:scale(.95)}.roll-btn.rolling[data-v-928a4131]{pointer-events:none;filter:brightness(1.5);animation:.5s infinite shake}.shop-container[data-v-928a4131]{grid-template-columns:1fr;gap:30px;width:100%;display:grid}.shop-section[data-v-928a4131]{border:1px solid var(--pm-gold);background:#fff9;border-radius:8px;padding:25px}.shop-title[data-v-928a4131]{color:var(--pm-dark-red);border-bottom:2px solid var(--pm-gold);letter-spacing:2px;justify-content:space-between;align-items:center;margin-bottom:20px;padding-bottom:10px;font-size:1.5em;font-weight:900;display:flex}.pm-input[data-v-928a4131]{box-sizing:border-box;background:#fffc;border:1px solid #ccc;border-radius:4px;outline:none;width:100%;margin-bottom:15px;padding:12px;font-family:inherit;font-size:1em;transition:border-color .3s}.pm-input[data-v-928a4131]:focus{border-color:var(--pm-dark-red);box-shadow:0 0 5px #8b000033}.pm-textarea[data-v-928a4131]{resize:vertical;box-sizing:border-box;background:#fffc;border:1px solid #ccc;border-radius:4px;outline:none;width:100%;height:80px;padding:12px;font-family:inherit;font-size:1em;transition:border-color .3s}.pm-textarea[data-v-928a4131]:focus{border-color:var(--pm-dark-red);box-shadow:0 0 5px #8b000033}.pm-select[data-v-928a4131]{background:#fffc;border:1px solid #ccc;border-radius:4px;outline:none;padding:12px;font-family:inherit;font-size:1em}.stat-grid[data-v-928a4131]{grid-template-columns:repeat(auto-fit,minmax(250px,1fr));gap:15px;display:grid}.stat-row[data-v-928a4131]{border-left:3px solid var(--pm-gold);background:#0000000d;border-radius:4px;justify-content:space-between;align-items:center;padding:10px 15px;display:flex}.stat-name[data-v-928a4131]{color:var(--pm-text);width:100px;font-weight:700}.stat-controls[data-v-928a4131]{align-items:center;gap:10px;display:flex}.stat-btn[data-v-928a4131]{border:1px solid var(--pm-dark-red);width:30px;height:30px;color:var(--pm-dark-red);cursor:pointer;background:0 0;border-radius:50%;font-weight:700;transition:all .2s}.stat-btn[data-v-928a4131]:hover:not(:disabled){background:var(--pm-dark-red);color:#fff}.stat-btn[data-v-928a4131]:disabled{color:#ccc;cursor:not-allowed;border-color:#ccc}.stat-val[data-v-928a4131]{text-align:center;width:40px;font-family:monospace;font-size:1.2em;font-weight:700}.stat-cost[data-v-928a4131]{color:#888;text-align:right;width:60px;font-size:.8em}.rl-grid[data-v-928a4131]{grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:20px;display:grid}.rl-card[data-v-928a4131]{cursor:pointer;background:#fcfaf5;border:1px solid #b89f7d;border-radius:6px;padding:15px;transition:all .3s;position:relative;overflow:hidden}.rl-card[data-v-928a4131]:hover{border-color:var(--pm-gold);transform:translateY(-2px);box-shadow:0 5px 15px #0000001a}.rl-card.selected[data-v-928a4131]{border-color:var(--pm-dark-red);box-shadow:inset 0 0 0 2px var(--pm-dark-red);background:#8b00000d}.rl-card.selected[data-v-928a4131]:after{content:\"✓\";color:var(--pm-dark-red);font-size:1.5em;font-weight:700;position:absolute;top:10px;right:15px}.rl-type[data-v-928a4131]{color:#888;margin-bottom:5px;font-family:monospace;font-size:.8em}.rl-name[data-v-928a4131]{color:var(--pm-black);margin-bottom:10px;font-size:1.2em;font-weight:700}.rl-desc[data-v-928a4131]{color:#555;margin-bottom:15px;font-size:.9em;line-height:1.5}.rl-cost[data-v-928a4131]{color:var(--pm-dark-red);text-align:right;font-family:monospace;font-weight:700}.rl-cost.refund[data-v-928a4131]{color:#2e7d32}.diy-list[data-v-928a4131]{flex-direction:column;gap:15px;margin-bottom:20px;display:flex}.diy-box[data-v-928a4131]{border:1px dashed var(--pm-gold);background:#00000008;border-radius:6px;padding:15px;position:relative}.diy-header[data-v-928a4131]{justify-content:space-between;align-items:center;margin-bottom:10px;display:flex}.diy-title[data-v-928a4131]{color:var(--pm-dark-red);font-size:1.1em;font-weight:700}.diy-roll-btn[data-v-928a4131]{background:var(--pm-gold);color:#fff;cursor:pointer;border:none;border-radius:4px;padding:8px 15px;font-weight:700;transition:all .2s}.diy-roll-btn[data-v-928a4131]:hover:not(:disabled){background:var(--pm-dark-red)}.diy-roll-btn[data-v-928a4131]:disabled{cursor:not-allowed;background:#ccc}.diy-cost-display[data-v-928a4131]{color:var(--pm-dark-red);font-family:monospace;font-size:1.2em;font-weight:700}.diy-cost-display.refund[data-v-928a4131]{color:#2e7d32}.btn-add-diy[data-v-928a4131]{border:1px dashed var(--pm-text);width:100%;color:var(--pm-text);cursor:pointer;background:0 0;border-radius:4px;padding:10px;font-weight:700;transition:all .2s}.btn-add-diy[data-v-928a4131]:hover{border-color:var(--pm-dark-red);color:var(--pm-dark-red);background:#0000000d}.btn-remove-diy[data-v-928a4131]{color:#f44;cursor:pointer;background:0 0;border:none;font-size:1.2em;font-weight:700;position:absolute;top:10px;right:10px}.btn-remove-diy[data-v-928a4131]:hover{transform:scale(1.2)}.dm-warning[data-v-928a4131]{border-left:4px solid var(--pm-dark-red);color:#555;background:#8b00000d;margin-bottom:20px;padding:15px;font-size:.95em;line-height:1.6}.dm-warning strong[data-v-928a4131]{color:var(--pm-dark-red)}.negative-warning[data-v-928a4131]{color:#8b0000;text-align:center;background:#8b00001a;border:2px solid #f44;border-radius:8px;margin-top:20px;padding:20px;font-weight:700;line-height:1.6;animation:2s infinite pulse-border-928a4131}@keyframes pulse-border-928a4131{0%{box-shadow:0 0 #f446}70%{box-shadow:0 0 15px #f440}to{box-shadow:0 0 #f440}}.price-table-details[data-v-928a4131]{border:1px solid var(--pm-gold);background:#fffc;border-radius:6px;margin-bottom:20px}.price-table-summary[data-v-928a4131]{color:var(--pm-dark-red);cursor:pointer;background:#d4af371a;padding:12px 20px;font-weight:700;list-style:none}.price-table-summary[data-v-928a4131]::-webkit-details-marker{display:none}.price-table-content[data-v-928a4131]{color:#444;border-top:1px dashed var(--pm-gold);padding:15px 20px;font-size:.9em;line-height:1.8}.price-table-content ul[data-v-928a4131]{margin:0;padding-left:20px}.price-table-content li[data-v-928a4131]{margin-bottom:5px}.custom-idea-box[data-v-928a4131]{width:100%;margin-top:20px}.custom-idea-box textarea[data-v-928a4131]{border:2px dashed var(--pm-gold);resize:vertical;box-sizing:border-box;background:#ffffffe6;border-radius:6px;outline:none;width:100%;min-height:150px;padding:15px;font-family:inherit;font-size:1.05em;line-height:1.6;transition:all .3s}.custom-idea-box textarea[data-v-928a4131]:focus{border-color:var(--pm-dark-red);border-style:solid;box-shadow:0 0 10px #8b00001a}.page-settings[data-v-928a4131]{flex-direction:column;align-items:center;width:100%;padding:40px 0;animation:.5s ease-out slideDown-928a4131;display:flex}.settings-title[data-v-928a4131]{color:var(--pm-dark-red);letter-spacing:8px;text-align:center;border-bottom:2px solid var(--pm-gold);width:100%;max-width:800px;margin-bottom:10px;padding-bottom:15px;font-size:2.5em;font-weight:900}.settings-warning[data-v-928a4131]{color:#555;letter-spacing:2px;text-align:center;margin-bottom:40px;font-style:italic}.toggles-grid[data-v-928a4131]{grid-template-columns:repeat(auto-fit,minmax(200px,1fr));gap:20px;width:100%;max-width:800px;margin-bottom:50px;display:grid}.toggle-btn[data-v-928a4131]{border:1px solid var(--pm-gold);text-align:center;cursor:pointer;color:#555;user-select:none;background:#ffffff80;border-radius:8px;padding:15px;font-weight:700;transition:all .3s;box-shadow:0 4px 6px #0000000d}.toggle-btn.active[data-v-928a4131]{background:var(--pm-dark-red);color:#fff;border-color:#5a0000;transform:translateY(-2px);box-shadow:0 5px 15px #8b00004d}.toggle-btn.active[data-v-928a4131]:after{content:\" [已开启]\";opacity:.8;font-size:.8em}.toggle-btn[data-v-928a4131]:not(.active):after{content:\" [已关闭]\";opacity:.8;font-size:.8em}.dm-section[data-v-928a4131]{border:1px dashed var(--pm-gold);box-sizing:border-box;background:#d4af370d;border-radius:8px;width:100%;max-width:800px;margin-bottom:30px;padding:30px}.dm-title[data-v-928a4131]{color:var(--pm-black);margin-bottom:15px;font-size:1.5em;font-weight:700}.dm-desc[data-v-928a4131]{color:#555;margin-bottom:20px;line-height:1.8}.dm-presets[data-v-928a4131]{flex-wrap:wrap;align-items:center;gap:15px;margin-bottom:20px;display:flex}.pm-preset-btn[data-v-928a4131]{border:1px solid var(--pm-dark-red);color:var(--pm-dark-red);cursor:pointer;background:0 0;border-radius:4px;padding:10px 20px;font-family:inherit;font-size:1em;transition:all .2s}.pm-preset-btn[data-v-928a4131]:hover,.pm-preset-btn.active[data-v-928a4131]{background:var(--pm-dark-red);color:#fff}.pm-preset-btn.custom-btn[data-v-928a4131]{border-style:dashed;font-weight:700}.mbti-diff-grid[data-v-928a4131]{grid-template-columns:1fr 1fr;gap:30px;width:100%;max-width:800px;margin-bottom:50px;display:grid}@media (width<=768px){.mbti-diff-grid[data-v-928a4131]{grid-template-columns:1fr}}.mbti-box[data-v-928a4131]{border:1px solid var(--pm-gold);background:#fff9;border-radius:8px;padding:20px}.mbti-row[data-v-928a4131]{background:#0000000d;border-radius:4px;justify-content:space-between;margin-bottom:10px;display:flex;overflow:hidden}.mbti-btn[data-v-928a4131]{cursor:pointer;color:#555;background:0 0;border:none;flex:1;padding:10px;font-weight:700;transition:all .2s}.mbti-btn.active[data-v-928a4131]{background:var(--pm-dark-red);color:#fff}.mbti-result[data-v-928a4131]{text-align:center;color:var(--pm-dark-red);letter-spacing:2px;margin-top:15px;font-size:1.5em;font-weight:900}.diff-box[data-v-928a4131]{border:1px solid var(--pm-gold);background:#fff9;border-radius:8px;flex-direction:column;gap:10px;padding:20px;display:flex}.diff-btn[data-v-928a4131]{border:1px solid var(--pm-dark-red);color:var(--pm-dark-red);cursor:pointer;text-align:left;background:0 0;border-radius:4px;padding:12px;font-weight:700;transition:all .2s}.diff-btn[data-v-928a4131]:hover,.diff-btn.active[data-v-928a4131]{background:var(--pm-dark-red);color:#fff}.pm-btn-embark[data-v-928a4131]{background:var(--pm-black);color:var(--pm-gold);border:2px solid var(--pm-gold);cursor:pointer;letter-spacing:8px;text-align:center;border-radius:8px;margin-top:20px;padding:20px 60px;font-size:1.5em;font-weight:900;transition:all .4s;display:inline-block;box-shadow:0 10px 20px #0000004d}.pm-btn-embark[data-v-928a4131]:hover:not(:disabled){background:var(--pm-dark-red);color:#fff;border-color:#f44;transform:translateY(-3px);box-shadow:0 15px 30px #8b000080}.pm-btn-embark[data-v-928a4131]:disabled{opacity:.6;cursor:not-allowed}.persona-grid[data-v-928a4131]{grid-template-columns:repeat(3,1fr);gap:15px;display:grid}@media (width<=768px){.pm-master-container[data-v-928a4131]{padding:15px 10px}.sys-title[data-v-928a4131]{letter-spacing:2px;font-size:1.8em}.sys-subtitle[data-v-928a4131]{margin-bottom:30px;font-size:1em}.cp-grid[data-v-928a4131]{grid-template-columns:1fr;gap:15px}.persona-grid[data-v-928a4131]{grid-template-columns:1fr}.points-header[data-v-928a4131]{text-align:center;flex-direction:column;align-items:center;gap:10px;padding:15px;position:relative}.points-header>div[data-v-928a4131]{flex-direction:column;justify-content:center;align-items:center;width:100%;display:flex;text-align:center!important}.preset-bar[data-v-928a4131]{flex-direction:column;align-items:stretch}.preset-bar>div[data-v-928a4131]{flex-direction:column;align-items:stretch;width:100%}.diy-header[data-v-928a4131]{flex-direction:column;align-items:flex-start;gap:10px}.diy-header>div[data-v-928a4131]{justify-content:space-between;align-items:center;width:100%;display:flex}.pm-btn-embark[data-v-928a4131]{letter-spacing:4px;box-sizing:border-box;width:100%;padding:15px 20px;font-size:1.2em}.sys-actions[data-v-928a4131]{flex-direction:column;gap:15px;width:100%}.sys-btn[data-v-928a4131]{width:100%}.cp-btn-confirm[data-v-928a4131]{padding:15px 20px}.bgm-player[data-v-928a4131]{opacity:.8;width:100%;margin-bottom:20px;position:relative}.dossier-content[data-v-928a4131]{padding:15px}.ds-type[data-v-928a4131]{width:60px;font-size:.8em}.ds-name[data-v-928a4131]{font-size:1.2em}.stat-row[data-v-928a4131]{padding:10px}.stat-name[data-v-928a4131]{width:80px;font-size:.9em}.stat-cost[data-v-928a4131]{width:50px;font-size:.75em}}.modal-overlay[data-v-928a4131]{z-index:999999;background:#000c;justify-content:center;align-items:center;padding:20px;display:flex;position:fixed;inset:0}.modal-content[data-v-928a4131]{background:var(--pm-bg-light);border:2px solid var(--pm-gold);border-radius:8px;flex-direction:column;width:100%;max-width:800px;max-height:90vh;padding:20px;display:flex;box-shadow:0 10px 30px #00000080}.modal-title[data-v-928a4131]{color:var(--pm-dark-red);text-align:center;margin-bottom:15px;font-size:1.5em;font-weight:700}.modal-textarea[data-v-928a4131]{resize:none;background:#f5f5f5;border:1px solid #ccc;border-radius:4px;outline:none;flex:1;width:100%;min-height:300px;margin-bottom:15px;padding:15px;font-family:monospace;font-size:14px}.modal-btn[data-v-928a4131]{background:var(--pm-dark-red);color:#fff;cursor:pointer;border:none;border-radius:4px;align-self:center;padding:12px 30px;font-size:1.2em;font-weight:700}.modal-btn[data-v-928a4131]:hover{background:#5a0000}\n/*$vite$:1*/";
...
var Qo = /* @__PURE__ */ At({
	...
	return n;
}, Kl = /* @__PURE__ */ Gl(Wl, [["__scopeId", "data-v-c36aba3a"]]), ql = {
	key: 0,
	class: "pm-master-container"
}, Jl = { class: "bgm-player" }, Yl = {
	key: 0,
	class: "modal-overlay"
}, Xl = { class: "modal-content" }, Zl = ["value"], Ql = {
	key: "already_started",
	class: "page-check"
}, $l = {
	key: "check",
	class: "page-check"
}, eu = { class: "sys-check-box" }, tu = {
	key: 0,
	class: "status-loading"
}, nu = { class: "sys-actions" }, ru = ["disabled"], iu = ["disabled"], au = {
	key: "transition",
	class: "transition-note"
}, ou = {
	key: "library",
	class: "library-scene"
}, su = { class: "scene-text" }, cu = { class: "highlight-gold" }, lu = { class: "dossier-container" }, uu = { class: "dossier-summary" }, du = { class: "ds-type" }, fu = { class: "ds-name" }, pu = { class: "ds-desc" }, mu = { class: "dossier-content" }, hu = {
	key: 0,
	class: "cp-quote"
	...
	gap: "10px",
	"align-items": "center"
} }, Lu = ["disabled"], Ru = { class: "shop-container" }, zu = { class: "shop-section" }, Bu = { class: "persona-grid" }, Vu = { class: "shop-section" }, Hu = { class: "stat-grid" }, Uu = { class: "stat-row" }, Wu = { class: "stat-controls" }, Gu = ["disabled"], Ku = { class: "stat-val" }, qu = ["disabled"], Ju = { class: "stat-row" }, Yu = { class: "stat-controls" }, Xu = ["disabled"], Zu = { class: "stat-val" }, Qu = { class: "stat-row" }, $u = { class: "stat-controls" }, ed = ["disabled"], td = { class: "stat-val" }, nd = { class: "stat-row" }, rd = { class: "stat-controls" }, id = ["disabled"], ad = { class: "stat-val" }, od = ["disabled"], sd = { class: "stat-row" }, cd = { class: "stat-controls" }, ld = ["disabled"], ud = { class: "stat-val" }, dd = ["disabled"], fd = { class: "stat-grid" }, pd = { class: "stat-name" }, md = { class: "stat-controls" }, hd = ["disabled", "onClick"], gd = { class: "stat-val" }, _d = ["disabled", "onClick"], vd = { class: "shop-section" }, yd = { class: "diy-list" }, bd = ["onClick"], xd = { class: "diy-header" }, Sd = { class: "diy-title" }, Cd = {
	key: 0,
	class: "diy-cost-display"
}, wd = ["disabled", "onClick"], Td = ["onUpdate:modelValue", "onInput"], Ed = ["onUpdate:modelValue", "onInput"], Dd = ["onUpdate:modelValue", "onChange"], Od = ["value"], kd = { class: "diy-list" }, Ad = ["onClick"], jd = { class: "diy-header" }, Md = { class: "diy-title" }, Nd = {
	key: 0,
	class: "diy-cost-display"
}, Pd = ["disabled", "onClick"], Fd = ["onUpdate:modelValue", "onInput"], Id = ["onUpdate:modelValue", "onInput"], Ld = ["onUpdate:modelValue", "onChange"], Rd = ["value"], zd = { class: "diy-list" }, Bd = ["onClick"], Vd = { class: "diy-header" }, Hd = { class: "diy-title" }, Ud = {
	key: 0,
	class: "diy-cost-display"
}, Wd = ["disabled", "onClick"], Gd = ["onUpdate:modelValue", "onInput"], Kd = ["onUpdate:modelValue", "onInput"], qd = ["onUpdate:modelValue", "onChange"], Jd = ["value"], Yd = { class: "diy-list" }, Xd = ["onClick"], Zd = { class: "diy-header" }, Qd = { class: "diy-title" }, $d = {
	key: 0,
	class: "diy-cost-display"
}, ef = ["disabled", "onClick"], tf = ["onUpdate:modelValue", "onInput"], nf = ["onUpdate:modelValue", "onInput"], rf = ["onUpdate:modelValue", "onChange"], af = ["value"], of = { class: "diy-list" }, sf = ["onClick"], cf = { class: "diy-header" }, lf = {
	class: "diy-title",
	style: { color: "var(--pm-dark-red)" }
}, uf = {
	key: 0,
	class: "diy-cost-display refund"
}, df = ["disabled", "onClick"], ff = ["onUpdate:modelValue", "onInput"], pf = ["onUpdate:modelValue", "onInput"], mf = ["onUpdate:modelValue", "onChange"], hf = ["value"], gf = { class: "shop-section" }, _f = { class: "rl-grid" }, vf = ["onClick"], yf = { class: "rl-type" }, bf = { class: "rl-name" }, xf = { class: "rl-desc" }, Sf = { class: "rl-cost" }, Cf = { class: "rl-grid" }, wf = ["onClick"], Tf = { class: "rl-type" }, Ef = { class: "rl-name" }, Df = { class: "rl-desc" }, Of = { class: "rl-cost" }, kf = { class: "rl-grid" }, Af = ["onClick"], jf = { class: "rl-type" }, Mf = { class: "rl-name" }, Nf = { class: "rl-desc" }, Pf = { class: "rl-cost refund" }, Ff = { class: "shop-section" }, If = { style: {
	display: "flex",
	"align-items": "center",
	gap: "10px",
	cursor: "pointer",
...
}, Rf = { class: "shop-section" }, zf = { class: "custom-idea-box" }, Bf = { style: {
	"text-align": "center",
	"margin-top": "40px"
} }, Vf = {
	key: 0,
	...
	"font-weight": "bold",
	"margin-bottom": "30px"
} }, Kf = { style: { "text-decoration": "underline" } }, qf = { class: "mbti-diff-grid" }, Jf = { class: "mbti-box" }, Yf = { class: "mbti-row" }, Xf = { class: "mbti-row" }, Zf = { class: "mbti-row" }, Qf = { class: "mbti-row" }, $f = { class: "mbti-result" }, ep = { class: "diff-box" }, tp = { class: "toggles-grid" }, np = ["onClick"], rp = { class: "dm-section" }, ip = { class: "dm-presets" }, ap = ["disabled"], op = /* @__PURE__ */ Gl(/* @__PURE__ */ Xn({
	__name: "SetupModal",
	setup(e) {
		...
		return (e, m) => t.value ? (q(), J("div", ql, [
			U(Y("div", Jl, [...m[43] ||= [Y("span", { style: {
				color: "var(--pm-gold)",
				"font-size": "0.8em"
			} }, "🎵 BGM Playing...", -1)]], 512), [[ro, a.value]]),
			o.value ? (q(), J("div", Yl, [Y("div", Xl, [
			...
			qi(za, {
				...
				default: Cn(() => [n.value === "already_started" ? (q(), J("div", Ql, [
				...
				])) : n.value === "check" ? (q(), J("div", $l, [
					m[49] ||= Y("div", { class: "sys-title" }, "白夜黑昼七日谈", -1),
					m[50] ||= Y("div", { class: "sys-subtitle" }, "The Seven Days of White Night and Dark Day", -1),
					Y("div", eu, [(q(!0), J(G, null, W(c, (e) => (q(), J("div", {
						key: e.id,
						class: "sys-row"
					}, [Y("span", null, I(e.label), 1), Y("span", null, [e.status === "loading" ? (q(), J("span", tu, "Checking...")) : (q(), J("span", {
						key: 1,
					...
					Y("div", nu, [Y("button", {
						...
						class: "sys-btn sys-btn-primary",
						onClick: _
					}, I(f.value ? "开始游戏" : "环境异常或校验中..."), 9, iu)])
				])) : n.value === "transition" ? (q(), J("div", au, [...m[51] ||= [Y("div", { class: "note-title" }, "【系统提示：来自梓墨的笔记簿】", -1), Y("ul", { class: "note-content" }, [
				...
				], -1)]])) : n.value === "library" ? (q(), J("div", ou, [Y("div", su, [
					d.value ? (q(), J(G, { key: 1 }, [
						m[59] ||= Y("p", null, "骨骼断裂的回音与神经烧焦的幻痛依然在脑海深处轰鸣。但此刻，你只是静静地站在温暖的图书室内，面前是那位戴着单片眼镜的少女。", -1),
						Y("p", null, [
							Y("q", null, [
								m[55] ||= X("“死亡并未宽恕你，", -1),
								Y("span", cu, I(u.value ? u.value : "伤痕累累的轮回者"), 1),
								m[56] ||= X("。”", -1)
							]),
				...
				]), Y("div", lu, [(q(), J(G, null, W(v, (e) => Y("details", {
					key: e.id,
					name: "char-accordion",
					class: "dossier-folder"
				}, [Y("summary", uu, [
					Y("span", du, I(e.type), 1),
					Y("span", fu, I(e.name), 1),
					Y("span", pu, I(e.desc), 1)
				]), Y("div", mu, [
					e.quote ? (q(), J("div", hu, [Y("q", null, I(e.quote), 1)])) : Zi("", !0),
					Y("div", gu, [Y("div", _u, [m[64] ||= Y("div", { class: "cp-box-title" }, "核心概念", -1), Y("div", vu, I(e.concept), 1)]), Y("div", yu, [m[65] ||= Y("div", { class: "cp-box-title" }, "生存难度", -1), Y("div", bu, I(e.diff), 1)])]),
					Y("div", xu, [Y("div", {
					...
					onClick: pe
				}, [...m[66] ||= [Y("span", { class: "ds-type" }, "CUSTOM", -1), Y("span", { class: "ds-name" }, "命运掷骰 (自定义车卡)", -1)]])])])) : n.value === "custom_char" ? (q(), J("div", Cu, [w.value === "pre-roll" ? (q(), J("div", wu, [
					m[67] ||= Y("h2", {
					...
					Y("div", {
						...
						onClick: ve
					}, [T.value ? (q(), J("span", Eu, "...")) : (q(), J("span", Tu, "ROLL"))], 2)
				])) : Zi("", !0), w.value === "shopping" ? (q(), J("div", Du, [
					Y("div", Ou, [Y("div", null, [m[70] ||= Y("h2", null, "黑市终端", -1), Y("div", ku, [m[69] ||= X("商店品质评级: ", -1), Y("span", Au, I(ye.value) + " (Roll: " + I(te.value) + ")", 1)])]), Y("div", ju, [m[71] ||= Y("div", { style: {
						"font-size": "0.8em",
						opacity: "0.8"
					...
					Y("div", Mu, [Y("div", Nu, [
						...
						U(Y("select", {
							...
							key: t,
							value: t
						}, I(e.name), 9, Pu))), 128))], 512), [[Bo, le.value]]),
						Y("button", {
							disabled: le.value === -1,
							class: "preset-btn",
							onClick: fe
					...
					Y("div", Ru, [
						...
						Y("div", vd, [
							...
							Y("div", yd, [
								...
								(q(!0), J(G, null, W(j.traits, (e, t) => (q(), J("div", {
									...
									Y("div", xd, [Y("span", Sd, "特质 #" + I(t + 1), 1), Y("div", null, [e.rolled ? (q(), J("span", Cd, "-" + I(e.cost) + " 点", 1)) : Zi("", !0), Y("button", {
										disabled: !e.tier,
										class: "diy-roll-btn",
									...
									U(Y("select", {
										...
										key: e.label,
										value: e.label
									}, I(e.label), 9, Od)), 64))], 40, Dd), [[Bo, e.tier]])
								]))), 128)),
								Y("button", {
									class: "btn-add-diy",
							...
							Y("div", kd, [
								...
								(q(!0), J(G, null, W(j.weapons, (e, t) => (q(), J("div", {
									...
									Y("div", jd, [Y("span", Md, "武器 #" + I(t + 1), 1), Y("div", null, [e.rolled ? (q(), J("span", Nd, "-" + I(e.cost) + " 点", 1)) : Zi("", !0), Y("button", {
										disabled: !e.tier,
										class: "diy-roll-btn",
										style: { "margin-left": "10px" },
									...
									U(Y("select", {
										...
										key: e.label,
										value: e.label
									}, I(e.label), 9, Rd)), 64))], 40, Ld), [[Bo, e.tier]])
								]))), 128)),
								Y("button", {
									class: "btn-add-diy",
							...
							Y("div", zd, [
								...
								(q(!0), J(G, null, W(j.armors, (e, t) => (q(), J("div", {
									...
									Y("div", Vd, [Y("span", Hd, "防具 #" + I(t + 1), 1), Y("div", null, [e.rolled ? (q(), J("span", Ud, "-" + I(e.cost) + " 点", 1)) : Zi("", !0), Y("button", {
										disabled: !e.tier,
										class: "diy-roll-btn",
										style: { "margin-left": "10px" },
									...
									U(Y("select", {
										...
										key: e.label,
										value: e.label
									}, I(e.label), 9, Jd)), 64))], 40, qd), [[Bo, e.tier]])
								]))), 128)),
								Y("button", {
									class: "btn-add-diy",
							...
							Y("div", Yd, [
								...
								(q(!0), J(G, null, W(j.items, (e, t) => (q(), J("div", {
									...
									Y("div", Zd, [Y("span", Qd, "道具 #" + I(t + 1), 1), Y("div", null, [e.rolled ? (q(), J("span", $d, "-" + I(e.cost) + " 点", 1)) : Zi("", !0), Y("button", {
										disabled: !e.tier,
										class: "diy-roll-btn",
										style: { "margin-left": "10px" },
							...
							Y("div", of, [
								...
								(q(!0), J(G, null, W(j.karmas, (e, t) => (q(), J("div", {
									...
									Y("div", cf, [Y("span", lf, "业障 #" + I(t + 1), 1), Y("div", null, [e.rolled ? (q(), J("span", uf, "+" + I(e.refund) + " 点", 1)) : Zi("", !0), Y("button", {
										disabled: !e.tier,
										class: "diy-roll-btn",
										style: {
											"margin-left": "10px",
									...
									U(Y("select", {
										...
										key: e.label,
										value: e.label
									}, I(e.label), 9, hf)), 64))], 40, mf), [[Bo, e.tier]])
								]))), 128)),
								Y("button", {
									class: "btn-add-diy",
									style: {
						...
						Y("div", gf, [
							...
							Y("div", _f, [(q(!0), J(G, null, W(M.backgrounds, (e) => (q(), J("div", {
								key: e.name,
							...
							Y("div", Cf, [(q(!0), J(G, null, W(M.egos, (e) => (q(), J("div", {
								key: e.name,
							...
							Y("div", kf, [(q(!0), J(G, null, W(M.karmas, (e) => (q(), J("div", {
								key: e.name,
						...
						Y("div", Ff, [
							...
							k.enabled ? (q(), J("div", Lf, [U(Y("input", {
					...
					Y("div", tp, [(q(!0), J(G, null, W(y.sensitiveToggles, (e, t) => (q(), J("div", {
						key: t,
						class: F(["toggle-btn", { active: e }]),
						onClick: (n) => y.sensitiveToggles[t] = !e
					}, I(String(t).replace(/_/g, " / ")), 11, np))), 128))]),
					Y("div", rp, [
					...
					Y("button", {
						...
						class: "pm-btn-embark",
						onClick: Oe
					}, I(r.value ? "引擎连接中..." : "踏上旅程"), 9, ap)
				])) : Zi("", !0)]),
				_: 1
			})
		])) : Zi("", !0);
	}
}), [["__scopeId", "data-v-928a4131"]]);
//#endregion
...
if (!window.__PM_SEVEN_DAYS_MOUNTED__) {
	...
	let e = /* @__PURE__ */ new Map(), t = null, n = () => {
		...
		i.forEach((e) => {
			...
			let l = n.textContent || "", u = n.getAttribute("is_user") === "true", d = l.includes("<initvar>") || l.includes("pm-custom-char-mount-point");
			if (l.includes("pm-custom-char-mount-point") && !n.hasAttribute("data-setup-mounted") && (n.setAttribute("data-setup-mounted", "true"), !r.getElementById("pm-setup-modal-root"))) {
				let e = r.createElement("div");
				e.id = "pm-setup-modal-root", e.style.cssText = "position: fixed; top: 0; left: 0; width: 100vw; height: 100vh; z-index: 2147483647;", r.body.appendChild(e), t = Yo(op), t.mount(e);
			}
			if (!u && !d) {
				let t = n.querySelector(".pm-status-bar-container");
				if (!t && !e.has(i)) {
					t = r.createElement("div"), t.className = "pm-status-bar-container", t.id = `pm-app-${i}`, n.appendChild(t);
					let a = Yo(Kl, { mesId: i });
					a.mount(t), e.set(i, a);
				}
			}
		...
		new MutationObserver((e) => {
			e.every((e) => {
				let t = e.target, n = t?.className, r = t?.id, i = typeof n == "string" && n.includes("pm-status-bar-container"), a = typeof r == "string" && r.includes("pm-app-");
				return i || a;
			}) || (t ? r = !0 : o());
		}).observe(e, {
			childList: !0,
